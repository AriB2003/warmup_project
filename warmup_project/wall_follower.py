...
class WallFollowerNode(Node):
    ...
    def run_loop(self):
        ...
        if (self.scan_results is not None):
            ...
            # If right wall, use right side data to determine heading. Default
            # is to left side data
            if right_wall == True:
                a_min += 180
                a_max += 180
                b_min += 180
            ...
            for i in range(a_min, a_max):
                if (self.scan_results[i] !=
                        math.inf and self.scan_results[i] != 0):
                    a = i
                    # print("a = ")
                    # print(a)
            ...
            try:
                ...
                if math.isnan(heading) == False:
                    ...
                    print(True)
            # If the sensor doesn't find any values in the given range, do
            # nothing
